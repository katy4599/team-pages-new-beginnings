  ...
  <div class="page-wrapper">
    <div class="compRow">
      ...
      <div class="compColumn-right">
        <div class="details">
          <h1 class="detailsFullName">
            {{ member.firstName }} {{ member.lastName }}
          </h1>
          <h2 v-if="member.pronouns != null" class="pronouns">
            ({{ member.pronouns }})
          </h2>
          <h3 class="detailsTitle">{{ member.title }}</h3>
          <h6 class="startYear">
            {{ member.firstName }} joined SnapIT in {{ member.startYear }}.
          </h6>
          <h6 v-if="member.jobLikes != 'Did not answer.'" class="jobLikes">
            {{ member.jobLikes }}
          </h6>
        </div>
      </div>
